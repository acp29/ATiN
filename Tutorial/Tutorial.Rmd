...
* Interpret and scrutinize data or output from software used to detect mEPSCs and measure their properties
...
quiz(
  ...
  question("What is the ideal mix of Na and Mg in the sucrose-based cutting solution?",
    answer("High Mg^2+^, High NaCl"),
    answer("Low Mg^2+^, Low NaCl"),
    answer("High Mg^2+^, Low NaCl", correct = TRUE),
    answer("Low Mg^2+^, High NaCl"),
    correct = "That's correct!",
    try_again = "Not quite, try again.",
    try_again_button = "Try again",
    allow_retry = TRUE
...
Click the `Load` button and locate the data file you have been allocated to analyse in the file dialog. The file will be located in the following directory: `S:\ATiN\Tutorial\Eventer\`  
...
* click the button decorated with a cursor pointer and click twice on the pop-up graph (Figure 7), before and after the artifact
...
**Figure 9** *Summary of your results from Eventer*
</center>
...
**Figure 11** *Using a machine learning model in Eventer*
</center>
...
We have detected mEPSCs and we have some basic summary data about them from Eventer. Lets now get some detailed data about the amplitude and kinetics of individual events. We will achieve this using the open source software package called Stimfit.
...
<br>
**Figure 12** *Open the Stimfit file open dialog*
</center>
<br>
...
<br>
**Figure 13** *Select the data file for analysis*
</center>
<br>
...
<br>
**Figure 14** *Stimfit with the data loaded*
</center>
...
<br>
**Figure 15** *Loading the cursor settings window*
</center>
<br>
...
<br>
**Figure 16** *Set the direction of mEPSC peak measurements*
</center>
<br>
...
<br>
**Figure 17** *Calculating the ensemble mean mEPSC*
</center>
...
<br>
**Figure 18** *Set the <font color="red">red</font> peak cursors*
</center>
<br>
...
<br>
**Figure 19** *Set the <font color="green">green</font> baseline cursors*
</center>
<br>
...
<br>
**Figure 20** *Measurement annotations*
</center>
<br>
...
<br>
**Figure 21** *Loading the batch analysis options*
</center>
<br>
...
<br>
**Figure 22** *Selecting batch analysis options*
</center>
<br>
...
* Introduction: Introduce patch clamp in brain slices and methods for detecting and analysing spontaneous synaptic currents.

* Methods: Choose to describe the methods for preparing and recording from either acute **OR** organotypic hypocampal slices. Summarise the approach used to detect mEPSCs from recordings and analyse mEPSC properties.

* Results: Using the data collected from your efforts in the class and provided to you by your tutor, present and interpret mEPSC detection results obtained by: 1) manual event screening (different users), and 2) by to using a single, trained machine learning model. 

* Discussion: Critically discuss your results and the application of the various techniques.
