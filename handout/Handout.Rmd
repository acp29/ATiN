...
| <font size="7">  `r emo::ji("thinking")` </font> | Points to ponder |  Consider these points and improve your understanding |  
...
| <font size="7">  `r emo::ji("thinking")` </font> POINTS TO PONDER |
|:---------------------------|

The following are advantages of recording from brain slices over recording *in vivo*:

* They are more amenable to controlled pharmacological intervention
* Whole-cell voltage-clamp experiments are more feasible

Note that experiments on brain slices does require the use of animals. Removing brain tissue from the animal typically disturbs the on-going the activity of neuronal circuits.

The following would be good situations to use patch clamp recordings in brain slices:  

* To characterize conductances underlying neuronal signalling using voltage-clamp and pharmacological tools
* To map out functional connectivity in local circuits
* To characterize microscopic currents from single channels, which contribute to membrane conductances
* To perform functional and anatomical characterization of neurones in a brain region.
* To examine how membrane conductances respond to specific concentrations of agents delivered inside the cell
...
[![](http://img.youtube.com/vi/EPYVjMOPcTE/0.jpg)](http://www.youtube.com/watch?v=EPYVjMOPcTE "Preparation of Acute Hippocampal Slices")
<br>
https://youtu.be/EPYVjMOPcTE

| <font size="7">  `r emo::ji("thinking")` </font> POINTS TO PONDER FOR ACUTE SLICES |
|:---------------------------|

The following represent the benefits of the cutting solution being ice-cold:  

* It increases oxygen solubility in the solution
* It slows the activity of enzymes acting to damage the slice
* It reduces the metabolism of the tissue and lowers the risk of hypoxia
* It reduces the metabolism of the tissue and lowers the risk of acidosis

The ideal mix of Mg^2+^, Ca^2+^ and NaCl in the sucrose-based cutting solution is: High Mg^2+^ High Ca^2+^ Low NaCl
Elevated Mg^2+^ (e.g. 7 mM) helps block NMDA receptors to reduce excitotoxicity and the high concentration of divalent cations is thought to result in screening membrane charges thereby raising the threshold of activation of voltage-gated ion channels. The higher Mg^2+^ also helps to antagonise the binding of Ca^2+^ to the putative Ca^2+^ sensor. Together with the lower Ca^2+^ (e.g. 0.5 mM), this helps to suppress seizure activity by reducing synaptic transmission thereby lowering the metabolic demands of the tissue. The low NaCl concentration (with osmolarity corrected with sucrose) helps to prevent cells from swelling by osmosis during the slicing procedure
...
[![](http://img.youtube.com/vi/GvUg0wiu_p8/0.jpg)](http://www.youtube.com/watch?v=GvUg0wiu_p8 "Preparation of Organotypic Hippocampal Slices")
<br>
https://youtu.be/GvUg0wiu_p8

| <font size="7">  `r emo::ji("thinking")` </font> POINTS TO PONDER FOR ORGANOTYPIC SLICE CULTURE |
|:---------------------------|

The pH buffering system most often used in cell culture is a balanced combination of 25 mM Na-HCO<sub>3</sub> + 5% CO<sub>2</sub>. This is the same buffering system used in the blood and CSF

The age of rodents typically used to prepare organotypic hippocampal slices is postnatal age 5-7 (P5-7). The success rate for culturing slices from rodents older than about P10 tends to drop and hippocampal slices cultured from younger animals (P0) do not maintain well the defined organisation and structure of the hippocampus
...
[![](http://img.youtube.com/vi/jETRgJp7DZY/0.jpg)](http://www.youtube.com/watch?v=jETRgJp7DZY "Patch Clamp Recording in Brain Slice")
<br>
https://youtu.be/jETRgJp7DZY

| <font size="7">  `r emo::ji("thinking")` </font> POINTS TO PONDER FOR PATCH CLAMP AND mEPSC RECORDING |
|:---------------------------|

The coating on the wires used for recording and ground electrodes is silver chloride, which helps to reduce the junction potential at the liquid-metal interface.

The current change when applying test voltage pulses for a the patch pipette in the bath -> cell-attached -> whole-cell configuration, will look be: large square pulse -> very small square pulse -> large, slow transient"

To ensure that spontaneous synaptic currents reflect miniature synaptic transmission (i.e. quantal transmission: the release of a single vesicle of neurotransmitter) we add tetradotoxin (~1 $\mu$M) to the aCSF. Tetradotoxin blocks voltage-dependent sodium channels thereby preventing action potential-evoked, and potentially multivesicular, neurotransmitter release. This just leaves the stochastic release of neurotransmitter vesicles

To ensure that spontaneous synaptic currents reflect excitatory rather than inhibitory synaptic currents we add picrotoxin (~50 $\mu$M). Picrotoxin blocks GABA<sub>A</sub> receptors, which mediate inhibitory postsynaptic currents.
...
[![](http://img.youtube.com/vi/gaRo8SijUtg/0.jpg)](http://www.youtube.com/watch?v=gaRo8SijUtg "Eventer video tutorial")
<br>
